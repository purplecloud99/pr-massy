...
export const metadata: Metadata = {
  ...
  description:
    "Premier inflatable rentals—bounce houses, water slides, and obstacle courses in Orange County & beyond. Same-day delivery & top-rated service.",
  keywords: [
    "inflatable rentals",
    "bounce house rental",
    "water slide rental",
  ...
  openGraph: {
    ...
    description:
      "Premier inflatable & bounce house rentals across Orange County & surrounding areas.",
